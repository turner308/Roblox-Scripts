local GlobalSettings = getgenv().Set

if typeof(GlobalSettings) == "table" then
	for i,v in pairs(GlobalSettings) do
...
local Lib = {}
    ...
    function Lib:CreateWindow(Name)
        ...
        function Window:String(options)
            text = options.string
            frontwords = options.frontwords or 4
            local Frame = Instance.new("Frame")
            local TextLabel = Instance.new("TextLabel")
            local Frame_2 = Instance.new("Frame")
            ...
            local String = ""
            for i,v in pairs(SplitString(text," ")) do
                if i <= frontwords and #text > 20 then
                    String = String.." "..v
                else
                    String = String.." "..v
                end
